...
// ---------------------------------------------------------------------------
// Mock programs — shown when API is unavailable
// ---------------------------------------------------------------------------

const MOCK_PROGRAMS: ApiProgram[] = [
  {
    id: "mock-001",
    program_type: "scholarship",
    source_type: "kosaf",
    source_id: "kosaf-national-1",
    title: "국가장학금 1유형",
    summary: "소득 수준에 따라 등록금의 전부 또는 일부를 지원",
    provider_name: "한국장학재단",
    official_url: null,
    program_status: "open",
    application_start_at: null,
    application_end_at: null,
    benefit_amount_monthly: null,
    benefit_amount_semester: 3200000,
    benefit_amount_once: null,
    region_scope: null,
    school_scope: null,
    tags: null,
    min_age: 18,
  ...
  },
  {
    ...
    program_type: "scholarship",
    source_type: "kosaf",
    source_id: "kosaf-national-2",
    title: "국가장학금 2유형",
    summary: "대학 자체 선발 기준에 따라 지원",
    provider_name: "한국장학재단",
    official_url: null,
    program_status: "open",
    application_start_at: null,
    application_end_at: null,
    benefit_amount_monthly: null,
    benefit_amount_semester: 1500000,
    benefit_amount_once: null,
    region_scope: null,
    school_scope: null,
    tags: null,
  ...
  },
  {
    ...
    source_type: "local",
    source_id: "busan-youth-rent",
    title: "부산 청년 월세 지원",
    summary: "부산 거주 무주택 청년 대상 월세 일부 지원",
    provider_name: "부산광역시",
    official_url: null,
    program_status: "open",
    application_start_at: null,
  ...
  },
  {
    ...
    source_type: "local",
    source_id: "busan-youth-pass",
    title: "부산 청년패스",
    summary: "부산 청년 대중교통비 최대 30% 환급",
    provider_name: "부산광역시",
    official_url: null,
    program_status: "always_open",
    application_start_at: null,
    application_end_at: null,
    benefit_amount_monthly: 40000,
    benefit_amount_semester: null,
    benefit_amount_once: null,
    region_scope: null,
    school_scope: null,
  ...
  },
  {
    ...
    source_id: "pnu-excellence",
    title: "부산대 성적우수 장학금",
    summary: "직전 학기 성적 우수자 대상",
    provider_name: "부산대학교",
    official_url: null,
    program_status: "open",
    application_start_at: null,
    application_end_at: null,
    benefit_amount_monthly: null,
    benefit_amount_semester: 1000000,
    benefit_amount_once: null,
    region_scope: null,
    school_scope: null,
    tags: null,
  ...
  },
  {
    ...
    source_type: "gov",
    source_id: "youth-hope-savings",
    title: "청년도약계좌",
    summary: "5년 만기, 정부 기여금 포함 최대 연 8.86% 적금",
    provider_name: "금융위원회",
    official_url: null,
    program_status: "always_open",
    application_start_at: null,
    application_end_at: null,
    benefit_amount_monthly: 70000,
    benefit_amount_semester: null,
    benefit_amount_once: null,
    region_scope: null,
    school_scope: null,
